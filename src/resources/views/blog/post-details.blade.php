        ...
        <div class="single-post nobottommargin">
            ...
            <div class="related-posts clearfix">
                <div class="col_full nobottommargin">
                    <blog-suggested-post v-for="(sPost, index) in posts" :key="sPost.id"
                                          v-if="index < 6 && sPost.id !== post.id" :post="sPost"
                                          :index="index" :show-admin-buttons="showAdminButtons"></blog-suggested-post>
                </div>
            </div> -->
        </div>
...
Vue.component('blog-suggested-post', {
